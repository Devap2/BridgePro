...
Bridge Pro is a free minecraft plugin, which is easily configurable and straightforward to use.
This plugin is based off a plugin from the server 'Nidocraft'. This is my own version which I decided to make for learning purposes.
